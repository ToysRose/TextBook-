...
public class MenuReviewCommentDAO {
	...
	public void insertComment(commentDate c) {
		try {
			SqlExcutor.update(
				"insert into tb_comen_stable(no, content, id, recom_cnt, co_no, g_code) values (?, ?, ?, ?, ?, tb_comen_stable_seq.nextval, 'mr')", 
