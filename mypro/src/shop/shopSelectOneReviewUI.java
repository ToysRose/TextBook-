...
public class shopSelectOneReviewUI {
	
	private Userdata LoginInfo;
	
	public shopSelectOneReviewUI(Userdata LoginInfo) {
	...
	public void service(int code) {
		...
		reviewDate b = new ShopReviewDAO().selectOneReview(no,code);
	...
	public void update(reviewDate b) {
		...
		new ShopReviewDAO().reviewUpdate(b);
	}
	public void delete(reviewDate b) {
		new ShopReviewDAO().reviewdelete(b);
	}
}
